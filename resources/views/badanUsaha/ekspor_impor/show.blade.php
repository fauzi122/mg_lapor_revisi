                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            @else
                                                ...
                                                <button type="button" class="btn btn-sm btn-success"
                                                    onclick="tambahPMB('{{ $bulan_ambil_eksporsx }}' )"
                                                ...
                                                @foreach ($expor as $expor)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if ($expor->status == '0')
                                                                <button type="button"
                                                                    class="btn btn-sm btn-info editEkpor mb-2"
                                        ...
                                        <div class="d-flex justify-content-end gap-2">
                                            ...
                                            @elseif ($statusbulan_ambil_imporsx == 2)
                                                <form action="{{ url('/submit_bulan_import') }}/{{ $id }}"
                                                    ...
                                                    <button type="button" class="btn btn-sm btn-info"
                                                        onclick="kirimData($(this).closest('form'))">
                                                        <i class="ki-solid ki-send"></i><span
                                                            title="Kirim semua data">Kirim Semua</span>
                                                    </button>
                                                </form>
                                                <button type="button" class="btn btn-sm btn-primary" disabled>
                                                    <i class="fas fa-plus"></i> Buat Laporan
                                            ...
                                            @else
                                                ...
                                                <button type="button" class="btn btn-sm btn-success"
                                                    onclick="tambahPMB('{{ $bulan_ambil_imporsx }}' )"
