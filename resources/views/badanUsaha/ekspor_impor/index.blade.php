                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($ekspor as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/eksport-import/show') }}/{{ $id }}/ekspor">
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/eksport-import/show') }}/{{ $id }}/ekspor/tahun">
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($impor as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/eksport-import/show') }}/{{ $id }}/impor">
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/eksport-import/show') }}/{{ $id }}/impor/tahun">
