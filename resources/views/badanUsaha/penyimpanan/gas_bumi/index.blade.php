    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack flex-wrap">
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                <h3 class="text-dark fw-bold">Penyimpanan Gas Bumi LNG/LPG Bulk/CNG/BBG/LPG Bottling Plant</h3>
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    ...
                    <li class="breadcrumb-item text-muted">Penyimpanan Gas Bumi</li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row w-100">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <a type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#excelpggb">
                        ...
                        <div class="card">
                            <div class="card-header align-items-center px-2">
                                ...
                                <div class="card-title flex-row-fluid justify-content-end gap-5">
                                    <input type="hidden" class="export-title" value="Laporan Penyimpanan Gas Bumi" />
                                </div>
                            </div>
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @foreach ($pm as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/penyimpanan-gas-bumi/show') }}/{{ $id }}">
                                                        {{ getBulan($data->bulan) }}
                                                        <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="{{ url('/penyimpanan-gas-bumi/show') }}/{{ $id }}/tahun">
                                                        {{ getTahun($data->bulan) }}
                                                        <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                    </a>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @else
                                                        <form action="{{ url('/hapus_bulan_pggb') }}/{{ $id }}" method="post" class="d-inline">
                                                            @method('delete')
                                                            @csrf
                                                        ...
                                                        <form action="{{ url('/submit_bulan_pggb') }}/{{ $id }}" method="post" class="d-inline" data-id="{{ $data->bulan }}">
                                                            @method('PUT')
                                                            @csrf
                                                        ...
                                                        <a href="{{ url('/penyimpanan-gas-bumi/show') }}/{{ $id }}" class="btn btn-icon btn-sm btn-info mb-2">
