                            ...
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a type="button" class="btn btn-sm btn-primary" onclick="produk('BBM'); provinsi(); sektor();" 
                                            data-bs-toggle="modal" data-bs-target="#input_HargaBBM">
                                            <i class="fas fa-plus"></i> Buat Laporan
                                        </a>
                                        <a type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#excelhbjbu">
                            ...
                            <div class="card">
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title" value="Laporan Harga BBM JBU/Hasil Olahan/Minyak Bumi" />
                                    </div>
                                </div>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($hargabbmjbu as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/niaga/harga/show') }}/{{ $id }}/bbmjbu/tahun">
                                                            {{ getTahun($data->bulan) }}
                                                            <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <form action="{{ url('/hapusbulanHargabbmjbu') }}/{{ $id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                            ...
                                                            <form action="{{ url('/submit_bulan_harga') }}/{{ $id }}" method="post" class="d-inline" data-id="{{ $data->bulan_peb }}">
                                                                @method('PUT')
                                                                @csrf
                                                            ...
                                                            <a href="{{ url('/niaga/harga/show') }}/{{ $id }}/bbmjbu" class="btn btn-icon btn-sm btn-info mb-2">
                    ...
                    <div class="card mb-5 mb-xl-8 shadow">
                        <div class="card-header bg-light p-5">
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a type="button" class="btn btn-sm btn-primary" onclick="produk(); provinsi(); sektor();" 
                                            data-bs-toggle="modal" data-bs-target="#inputHargaLPG">
                                            <i class="fas fa-plus"></i> Buat Laporan
                                        </a>
                                        <a type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#excelHargaLPG">
                                            <i class="fas fa-upload"></i> Import Excel
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($hargaLPG as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ url('/niaga/harga/show') }}/{{ $id }}/hargalpg/tahun">
                                                            {{ getTahun($data->bulan) }}
                                                            <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <form action="{{ url('/hapusbulanHargaLPG') }}/{{ $id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button" class="btn btn-icon btn-sm btn-danger mb-2" onclick="hapusData($(this).closest('form'))">
                                                                    <i class="ki-solid ki-trash" title="Hapus data"></i>
                                                            ...
                                                            <form action="{{ url('/submitbulanHargaLPG') }}/{{ $id }}" method="post" class="d-inline" data-id="{{ $data->bulan }}">
                                                                @method('PUT')
                                                                @csrf
                                                                <button type="button" class="btn btn-icon btn-sm btn-success mb-2" onclick="kirimData($(this).closest('form'))">
                                                                    <i class="ki-solid ki-send" title="Revisi"></i>
                                                            ...
                                                            <a href="{{ url('/niaga/harga/show') }}/{{ $id }}/hargalpg" class="btn btn-icon btn-sm btn-info mb-2">
                                                                <i class="ki-solid ki-pencil" title="Detail / Edit Data"></i>
                                                            </a>
                                                        @endif
                                                    </td>
