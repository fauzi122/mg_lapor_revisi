                            ...
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_harga-bbm-jbu') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="produk('BBM'); provinsi(); sektor(); tambahPMB('{{ $bulan_ambil_hargabbmjbux }}');"
                                            data-bs-toggle="modal" data-bs-target="#input_HargaBBM"
                                            {{ $statushargabbmjbux == 1 || $statushargabbmjbux == 2 ? 'disabled' : '' }}>
                                            <i class="fas fa-plus"></i> Buat Laporan {{ dateIndonesia($bulan_ambil_hargabbmjbux) }}
                                        </button>
                                        <button type="button" class="btn btn-sm btn-success" onclick="tambahPMB('{{ $bulan_ambil_hargabbmjbux }}' )"
                                                    ...
                                                    <td class="text-center">
                                                        @if ($hargabbmjbu->status == '0' || $hargabbmjbu->status == '-' || $hargabbmjbu->status == '')
                                                            <button type="button" class="btn btn-sm btn-info editHarga mb-2"
                                                                onclick="edit_hargabbmx('{{ $hargabbmjbu->id }}')"  id="editharga"
                                                                data-bs-toggle="modal" data-bs-target="#edit-hargabbm" data-id="{{ $hargabbmjbu->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                            <form action="{{ url('/harga-bbm-jbu') }}/{{ $hargabbmjbu->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                        ...
                                                        @elseif ($hargabbmjbu->status == 1)
                                                            <span class="badge badge-success">Diterima</span>
                                                        @elseif ($hargabbmjbu->status == 2)
                                                            <span class="badge badge-danger" data-bs-toggle="modal" data-bs-target="#modal-updateStatus-{{ $hargabbmjbu->id }}">
                                                                Cek Revisi
                                                            </span>
                                                        @endif
                                                    </td>
