                            ...
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_pengolahan_gas_bumi_produksi') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                        ...
                                        <button type="button" class="btn btn-sm btn-success" onclick="tambahPMB('{{ $bulan_ambil_produksix }}' )"
                                            data-bs-toggle="modal" data-bs-target="#excelPengolahanGBProduksi"
                                            {{ $status_produksix != 0 ? 'disabled' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($ppgb->status == '0' || $ppgb->status == '' || $ppgb->status == '-')
                                                            ...
                                                            <form action="{{ url('/hapus_pengolahan_gas_bumi_produksi') }}/{{ $ppgb->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-info mb-2" id="" data-bs-toggle="modal" 
                                                            ...
                                                            data-bs-target="#lihat-pengolahan-produksi-gb" data-id="{{ $ppgb->id }}">
                    ...
                    <div class="card mb-5 mb-xl-8 shadow">
                        <div class="card-header bg-light p-5">
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_pengolahan_gas_bumi_pasokan') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                            <button type="button" class="btn btn-sm btn-info" onclick="kirimData($(this).closest('form'))"
                                        ...
                                        <tbody>
                                            @foreach ($pengolahanPasokanGB as $ppgb)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($ppgb->status == '0' || $ppgb->status == '' || $ppgb->status == '-')
                                                            <button type="button" class="btn btn-sm btn-info edit-pengolahan-pasokan-gb mb-2"
                                                                onclick="editPengolahan('{{ $ppgb->id }}', '{{ $ppgb->intake_kilang }}', '{{ $ppgb->kabupaten_kota }}', '{{ $ppgb->status }}' )" 
                                                                data-bs-toggle="modal" data-bs-target="#edit-pengolahan-pasokan-gb" data-id="{{ $ppgb->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                            <form action="{{ url('/hapus_pengolahan_gas_bumi_pasokan') }}/{{ $ppgb->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button" class="btn btn-sm btn-danger mb-2" onclick="hapusData($(this).closest('form'))">
                                                                    <i class="ki-solid ki-trash" title="Hapus data"></i>
                                                        ...
                                                        @elseif($ppgb->status == "2")
                                                            <button type="button" class="btn btn-sm btn-info edit-pengolahan-pasokan-gb mb-2"
                                                                onclick="editPengolahan('{{ $ppgb->id }}', '{{ $ppgb->intake_kilang }}', '{{ $ppgb->kabupaten_kota }}', '{{ $ppgb->status }}' )" 
                                                                data-bs-toggle="modal" data-bs-target="#edit-pengolahan-pasokan-gb" data-id="{{ $ppmb->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                        @endif
                                                        <button type="button" class="btn btn-sm btn-info mb-2" id="" data-bs-toggle="modal" 
                                                            onclick="lihatPengolahan('{{ $ppgb->id }}' )" 
                                                            data-bs-target="#lihat-pengolahan-pasokan-gb" data-id="{{ $ppgb->id }}">
                                                            <i class="ki-solid ki-eye" title="Lihat data"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <div class="card mb-5 mb-xl-8 shadow">
                        <div class="card-header bg-light p-5">
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_pengolahan_gas_bumi_distribusi') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                            <button type="button" class="btn btn-sm btn-info" onclick="kirimData($(this).closest('form'))"
                                        ...
                                        <tbody>
                                            @foreach ($pengolahanDistribusiGB as $ppgb)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($ppgb->status == '0' || $ppgb->status == '' || $ppgb->status == '-')
                                                            <button type="button" class="btn btn-sm btn-info edit-pengolahan-distribusi-gb mb-2"
                                                                onclick="editPengolahan('{{ $ppgb->id }}', '{{ $ppgb->produk }}', '{{ $ppgb->kabupaten_kota }}', '{{ $ppgb->status }}' )" 
                                                                data-bs-toggle="modal" data-bs-target="#edit-pengolahan-distribusi-gb" data-id="{{ $ppgb->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                            <form action="{{ url('/hapus_pengolahan_gas_bumi_distribusi') }}/{{ $ppgb->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button" class="btn btn-sm btn-danger mb-2" onclick="hapusData($(this).closest('form'))">
                                                                    <i class="ki-solid ki-trash" title="Hapus data"></i>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-info mb-2" id="" data-bs-toggle="modal" 
                                                            onclick="lihatPengolahan('{{ $ppgb->id }}' )" 
                                                            data-bs-target="#lihat-pengolahan-distribusi-gb" data-id="{{ $ppgb->id }}">
                                                            <i class="ki-solid ki-eye" title="Lihat data"></i>
                                                        </button>
                                                    </td>
                                                </tr>
