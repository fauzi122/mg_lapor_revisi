                            ...
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_pengolahan_minyak_bumi_produksi') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="produk(); provinsi(); tambahPMB('{{ $bulan_ambil_produksix }}' );"
                                            data-bs-toggle="modal" data-bs-target="#buat-pengolahan-produksi-mb"
                                            {{ $status_produksix != 0 ? 'disabled' : '' }}>
                                            <i class="fas fa-plus"></i> Buat Laporan {{ dateIndonesia($bulan_ambil_produksix) }}
                                        </button>
                                        <button type="button" class="btn btn-sm btn-success" onclick="tambahPMB('{{ $bulan_ambil_produksix }}' )"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($ppmb->status == '0' || $ppmb->status == '' || $ppmb->status == '-')
                                                            <button type="button" class="btn btn-sm btn-info edit-pengolahan-produksi-mb mb-2"
                                                                onclick="editPengolahan('{{ $ppmb->id }}', '{{ $ppmb->produk }}', '{{ $ppmb->kabupaten_kota }}', '{{ $ppmb->status }}' )" 
                                                                data-bs-toggle="modal" data-bs-target="#edit-pengolahan-produksi-mb" data-id="{{ $ppmb->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                            <form action="{{ url('/hapus_pengolahan_minyak_bumi_produksi') }}/{{ $ppmb->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-info mb-2" id="" data-bs-toggle="modal" 
                                                            ...
                                                            data-bs-target="#lihat-pengolahan-produksi-mb" data-id="{{ $ppmb->id }}">
                    ...
                    <div class="card mb-5 mb-xl-8 shadow">
                        <div class="card-header bg-light p-5">
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_pengolahan_minyak_bumi_pasokan') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                            <button type="button" class="btn btn-sm btn-info" onclick="kirimData($(this).closest('form'))"
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="intake_kilang(); provinsi(); tambahPMB('{{ $bulan_ambil_pasokanx }}' );"
                                            data-bs-toggle="modal" data-bs-target="#buat-pengolahan-pasokan-mb"
                                            {{ $status_pasokanx != 0 ? 'disabled' : '' }}>
                                            <i class="fas fa-plus"></i> Buat Laporan {{ dateIndonesia($bulan_ambil_pasokanx) }}
                                        </button>
                                        <button type="button" class="btn btn-sm btn-success" onclick="tambahPMB('{{ $bulan_ambil_pasokanx }}' );"
                                        ...
                                        <tbody>
                                            @foreach ($pengolahanPasokanMB as $ppmb)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($ppmb->status == '0' || $ppmb->status == '' || $ppmb->status == '-')
                                                            <button type="button" class="btn btn-sm btn-info edit-pengolahan-pasokan-mb mb-2"
                                                                onclick="editPengolahan('{{ $ppmb->id }}', '{{ $ppmb->intake_kilang }}', '{{ $ppmb->kabupaten_kota }}', '{{ $ppmb->status }}' )" 
                                                                data-bs-toggle="modal" data-bs-target="#edit-pengolahan-pasokan-mb" data-id="{{ $ppmb->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                            <form action="{{ url('/hapus_pengolahan_minyak_bumi_pasokan') }}/{{ $ppmb->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button" class="btn btn-sm btn-danger mb-2" onclick="hapusData($(this).closest('form'))">
                                                                    <i class="ki-solid ki-trash" title="Hapus data"></i>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-info mb-2" id="" data-bs-toggle="modal" 
                                                            onclick="lihatPengolahan('{{ $ppmb->id }}' )" 
                                                            data-bs-target="#lihat-pengolahan-pasokan-mb" data-id="{{ $ppmb->id }}">
                                                            <i class="ki-solid ki-eye" title="Lihat data"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <div class="card mb-5 mb-xl-8 shadow">
                        <div class="card-header bg-light p-5">
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <form action="{{ url('/submit_bulan_pengolahan_minyak_bumi_distribusi') }}/{{ $id }}" method="post" class="d-inline">
                                            @method('put')
                                            @csrf
                                            <button type="button" class="btn btn-sm btn-info" onclick="kirimData($(this).closest('form'))"
                                        ...
                                        <button type="button" class="btn btn-sm btn-primary" onclick="produk(); provinsi(); tambahPMB('{{ $bulan_ambil_distribusix }}' ); sektor();"
                                            data-bs-toggle="modal" data-bs-target="#buat-pengolahan-distribusi-mb"
                                            {{ $status_distribusix != 0 ? 'disabled' : '' }}>
                                            <i class="fas fa-plus"></i> Buat Laporan {{ dateIndonesia($bulan_ambil_distribusix) }}
                                        </button>
                                        <button type="button" class="btn btn-sm btn-success" onclick="tambahPMB('{{ $bulan_ambil_distribusix }}' );"
                        ...
                        <div class="card-body p-3">
                            <div class="card">
                                <div class="card-header align-items-center px-2">
                                    <div class="card-toolbar"></div> <!-- Export & Col Visible Table -->
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title" value="Laporan Distribusi/Penjualan Domestik Kilang" />
                                    </div>
                                </div>
                                <div class="card-body p-2">
                                    <table class="kt-datatable table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            @foreach ($pengolahanDistribusiMB as $ppmb)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if ($ppmb->status == '0' || $ppmb->status == '' || $ppmb->status == '-')
                                                            <button type="button" class="btn btn-sm btn-info edit-pengolahan-distribusi-mb mb-2"
                                                                onclick="sektor(); editPengolahan('{{ $ppmb->id }}', '{{ $ppmb->produk }}', '{{ $ppmb->kabupaten_kota }}', '{{ $ppmb->status }}' );" 
                                                                data-bs-toggle="modal" data-bs-target="#edit-pengolahan-distribusi-mb" data-id="{{ $ppmb->id }}">
                                                                <i class="ki-solid ki-pencil" title="Edit Data"></i>
                                                            </button>
                                                            <form action="{{ url('/hapus_pengolahan_minyak_bumi_distribusi') }}/{{ $ppmb->id }}" method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button" class="btn btn-sm btn-danger mb-2" onclick="hapusData($(this).closest('form'))">
                                                                    <i class="ki-solid ki-trash" title="Hapus data"></i>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-info mb-2" id="" data-bs-toggle="modal" 
                                                            onclick="lihatPengolahan('{{ $ppmb->id }}' )" 
                                                            data-bs-target="#lihat-pengolahan-distribusi-mb" data-id="{{ $ppmb->id }}">
                                                            <i class="ki-solid ki-eye" title="Lihat data"></i>
                                                        </button>
                                                    </td>
                                                </tr>
