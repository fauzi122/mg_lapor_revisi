...
<div class="modal fade" tabindex="-1" id="edit-pengolahan-produksi-mb">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/update_pengolahan_minyak_bumi_produksi') }}" class="form-material"
        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/importPengolahanMBProduksi') }}" class="form-material m-t-40"
                ...
                <div class="modal-footer text-start">
                    <div class="row w-100">
                        <div class="col-6">
                            <a href="{{ url('/storage') }}/template/pengolahanMinyakBumi_ProduksiKilang.xlsx"
            ...
            <form method="post" action="{{ url('/simpan_pengolahan_minyak_bumi_pasokan') }}"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-6">
                        ...
                        <select class="form-select nama_kota" name="kabupaten_kota[]" id="kabupaten_kota"
...
<div class="modal fade" tabindex="-1" id="edit-pengolahan-pasokan-mb">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/update_pengolahan_minyak_bumi_pasokan') }}" class="form-material"
        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/importPengolahanMBPasokan') }}" class="form-material m-t-40"
                ...
                <div class="modal-footer text-start">
                    <div class="row w-100">
                        <div class="col-6">
                            <a href="{{ url('/storage') }}/template/pengolahanMinyakBumi_PasokanKilang.xlsx"
                                class="btn btn-success">Download Template</a>
                        </div>
                        <div class="col-6">
                            <div class="text-end">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/update_pengolahan_minyak_bumi_distribusi') }}"
                class="form-material" enctype="multipart/form-data" id="form_updatePengolahanDistribusiMB">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <input type="hidden" name="npwp" value="{{ Auth::user()->npwp }}">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/importPengolahanMBDistribusi') }}" class="form-material m-t-40"
                ...
                <div class="modal-footer text-start">
                    <div class="row w-100">
                        <div class="col-6">
                            <a href="{{ url('/storage') }}/template/pengolahanMinyakBumi_DistribusiKilang.xlsx"
                                class="btn btn-success">Download Template</a>
                        </div>
                        <div class="col-6">
                            <div class="text-end">
