...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion mt-2 {{ $isMasterActive ? 'here show' : '' }}">
    ...
    <div class="menu-sub menu-sub-accordion mt-2">
        <div class="menu-item">
            <a href="{{ url('/master/produk') }}" class="menu-link {{ request()->is('master/produk') ? 'active shadow' : '' }}">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                <span class="menu-title">Keterangan Produk</span>
            </a>
        </div>
        <div class="menu-item">
            <a href="{{ url('/master/inco-term') }}" class="menu-link {{ request()->is('master/inco-term') ? 'active shadow' : '' }}">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                <span class="menu-title">Inco Term</span>
            </a>
        </div>
        <div class="menu-item">
            <a href="{{ url('/master/port') }}" class="menu-link {{ request()->is('master/port') ? 'active shadow' : '' }}">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                <span class="menu-title">Port</span>
            </a>
        </div>
        <div class="menu-item">
            <a href="{{ url('/master/negara') }}" class="menu-link {{ request()->is('master/negara') ? 'active shadow' : '' }}">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                <span class="menu-title">Negara</span>
            </a>
        </div>
        <div class="menu-item">
            <a href="{{ url('/master/intake_kilangs') }}" class="menu-link {{ request()->is('master/intake_kilangs') ? 'active shadow' : '' }}">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
        ...
        <div class="menu-item">
            <a href="{{ url('/master/jabatan') }}" class="menu-link {{ request()->is('master/jabatan') ? 'active shadow' : '' }}">
                <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
