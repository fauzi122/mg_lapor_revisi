<div id="kt_app_sidebar" class="app-sidebar" 
    ...
    <div class="app-sidebar-secondary w-100">
        <div id="kt_app_sidebar_secondary_wrapper" class="hover-scroll-y" 
            ...
            <div class="app-sidebar-menu menu menu-sub-indention menu-rounded menu-column kt_app_sidebar_secondary_menu" data-kt-menu="true">
                {{-- Dashboard --}}
