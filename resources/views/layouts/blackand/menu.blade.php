                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/laporan/jual-hasil-olahan') }}" data-key="t-invoice-list">Penjualan Hasil Olahan/Minyak Bumi</a></li>
                                <li><a href="{{ url('/laporan/pasokan-hasil-olahan') }}" data-key="t-invoice-detail">Pasokan Hasil Olahan/Minyak Bumi</a></li>
                            </ul>
                        </li>
                        @endcan
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                @can('Minyak Bumi')
                                <li><a href="{{ url('/laporan/harga-bbm') }}" data-key="t-user-grid">Harga BBM JBU</a></li>
                                @endcan
                                @can('LPG/GAS')
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/laporan/jual/lng-cng-bbg') }}" data-key="t-blog-grid">Penjualan LNG/CNG/BBG</a></li>
                                <li><a href="{{ url('/laporan/pasok/lng-cng-bbg') }}" data-key="t-blog-list">Pasokan LNG/CNG/BBG</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/laporan/jual/lpg') }}" data-key="t-blog-grid">Penjualan LPG</a></li>
                                <li><a href="{{ url('/laporan/pasok/lpg') }}" data-key="t-blog-list">Pasokan LPG</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript: void(0);" class="has-arrow">
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/laporan/jual/gbmp') }}" data-key="t-blog-grid">Penjualan Gas Bumi</a></li>
                                <li><a href="{{ url('/laporan/pasok/gbmp') }}" data-key="t-blog-list">Pasokan Gas Bumi</a></li>
                            </ul>
                        </li>
                        @endcan
                        @can('Minyak Bumi')
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/laporan/produksi/mb') }}" data-key="t-blog-grid">Produksi Kilang</a></li>
                                <li><a href="{{ url('/laporan/pasokan/mb') }}" data-key="t-blog-list">Pasokan Kilang</a></li>
                                <li><a href="{{ url('/laporan/distribusi/mb') }}" data-key="t-blog-list">Distribusi/Penjualan Domestik Kilang </a></li>
                            </ul>
                        </li>
                        @endcan
                        @can('LPG/GAS')
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ url('/laporan/produksi/gb') }}" data-key="t-blog-grid">Produksi Kilang</a></li>
                                <li><a href="{{ url('/laporan/pasokan/gb') }}" data-key="t-blog-list">Pasokan Kilang</a></li>
                                <li><a href="{{ url('/laporan/distribusi/gb') }}" data-key="t-blog-list">Distribusi/Penjualan Domestik Kilang </a></li>
                            </ul>
                        </li>
                        @endcan
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                @can('Minyak Bumi')
                                <li><a href="{{ url('/laporan/penyimpanan/mb') }}" data-key="t-blog-list">Minyak Bumi</a></li>
                                @endcan
                                @can('LPG/GAS')
                                <li><a href="{{ url('/laporan/penyimpanan/gb') }}" data-key="t-blog-list">Gas Bumi</a></li>
                                @endcan
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                @can('Minyak Bumi')
                                <li><a href="{{ url('/laporan/pengangkutan/mb') }}" data-key="t-blog-list">Minyak Bumi</a></li>
                                @endcan
                                @can('LPG/GAS')
                                <li><a href="{{ url('/laporan/pengangkutan/gb') }}" data-key="t-blog-list">Gas Bumi</a></li>
                                @endcan
                            </ul>
                        </li>
                    </ul>
