                ...
                <div class="app-header-brand ps-6">
                    ...
                    <a class="app-sidebar-secondary-collapse-d-none" href="{{ route('dashboard') }}">
                        ...
                        <span class="badge badge-light-dark">
                            <h5>Pelaporan Migas</h5>
                        </span>
                    </a>
                    <button id="kt_app_sidebar_secondary_toggle"
                        class="btn btn-sm btn-icon bg-body btn-color-gray-400 btn-active-color-primary d-none d-lg-flex ms-2"
                    ...
                    <div class="app-container container-fluid">
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item">
                                <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px ms-1 ms-md-3"
                            ...
                            <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-md-40px"
                                    ...
                                    @if (Auth::user()->role == 'BU')
                                        <img src="{{ asset('assetsMetronic/media/company_img.png') }}"
                                            alt="user" />
                                    @else
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            <div class="symbol symbol-50px me-5">
                                                @if (Auth::user()->role == 'BU')
                                                    <img alt="Logo"
                                                        src="{{ asset('assetsMetronic/media/company_img.png') }}" />
                                                @else
                                                    <img alt="Logo"
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">
                                                    {{ Auth::user()->name }}
                                                    <span
                                                        class="badge badge-light-success fw-bold fs-9 px-2 py-1 ms-2">{{ Auth::user()->role }}</span>
                                                </div>
                                                <a href="#"
                                                    class="fw-semibold text-muted text-hover-primary fs-10">{{ Auth::user()->email }}</a>
                                            </div>
                                        </div>
                                    </div>
