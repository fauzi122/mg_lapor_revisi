    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        <div class="card mb-5 mb-xl-8 shadow">
            <div class="card-body p-4">
                <form method="post" action="{{ url('/master/meping') }}" class="form-material m-t-40" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div>
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-solid" placeholder="Masukan Kode" type="text" name="izin" value="{{ old('izin') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mt-3 mt-lg-0">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-solid" placeholder="Masukan Nama Izin" type="text" name="nm_izin" value="{{ old('nm_izin') }}">
                                </div>
                            </div>
                        </div>
                    </div>
