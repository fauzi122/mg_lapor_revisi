                        ...
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('/user-admin') }}" class="btn btn-primary waves-effect waves-light">
                                    <i class="bi bi-file-earmark-plus fs-4"></i> Tambah Data
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="User Access" />
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($user->getRoleNames()->isNotEmpty())
                                                <span class="badge bg-success rounded-pill" style="font-size: 1em;">
                                                    {{ implode(', ', $user->getRoleNames()->toArray()) }}
                                                </span>
                                            @else
                                                <span class="badge bg-secondary rounded-pill">No Roles Assigned</span>
                                            @endif
                                        </td>
                                        <td>
                                            @php
