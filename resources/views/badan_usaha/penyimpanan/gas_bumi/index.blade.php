                                    ...
                                    <tbody>
                                        @foreach ($pm as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td><b><a
                                                            href="{{ url('/penyimpanan-gas-bumi/show/bulan') }}/{{ $id }}">{{ getbulan($data->bulan) }}<i
                                                                class="bx bx-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td><b><a
                                                            href="{{ url('/penyimpanan-gas-bumi/show/bulan') }}/{{ $id }}">{{ getTahun($data->bulan) }}<i
                                                                class="bx bx-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td>
                                                ...
                                                @if ($data->status_tertinggi == 1 || $data->status_tertinggi == 3)
                                                    <td>
                                                        <form action="{{ url('/hapus_bulan_pggb') }}/{{ $data->bulan }}"
                                                        ...
                                                        <form action="{{ url('/submit_bulan_pggb') }}/{{ $data->bulan }}"
