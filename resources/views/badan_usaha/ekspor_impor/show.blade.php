                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        ...
                                        @if ($statusbulan_ambil_eksporsx == 1)
                                            <form action="/submit_bulan_export/{{ $bulan_ambil_eksporsx . '-01' }}"
                                    ...
                                    <tr>
                                        ...
                                        if ($status=="0"){ ?>
                                            ...
                                            <form action="/hapus_import/{{ $impor->id }}" method="post" class="d-inline">
                                                @method('delete')
>>>>>>> 3cf18f77e4ebf7e2d91c48eaa5ccf22e46e44e33
                                                @csrf
                                                <button type="button" class="btn btn-info"
                                                    onclick="kirimData($(this).closest('form'))" disabled>
                                                    <span title="Kirim semua data">Kirim Semua</span>
                                            ...
                                            <button type="button" class="btn btn-primary waves-effect waves-light"
                                                onclick="produk(); provinsi(); negara(); pelabuhan(); incoterms(); tambahPMB('{{ $bulan_ambil_eksporsx }}');"
                                ...
                                <div class="table-responsive">
                                    <table id="table1" class="table table-bordered dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            $status=$expor->status;
                                            if ($status=="0"){ ?>
                                                        <center><button type="button" class="btn btn-sm btn-info editEkpor"
                                                                id="editCompany"
                                                                onclick="edit_ekpor('{{ $expor->id }}', '{{ $expor->produk }}' , '{{ $expor->negara_tujuan }}'  )"
                                                                data-bs-toggle="modal" data-bs-target="#modal-edit"
                                                                data-id="{{ $expor->id }}"> <i class="bx bx-edit-alt"
                                                                    title="Edit data"></i></button>
                                                            <form action="/hapus_export/{{ $expor->id }}" method="post"
                                                                class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-info "
                                                                ...
                                                                data-id="{{ $expor->id }}"> <i class="bx bx-show-alt"
