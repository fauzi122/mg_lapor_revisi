...
<div id="buat-pengolahan-produksi-mb" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/simpan_pengolahan_minyak_bumi_produksi') }}"
...
<div id="edit-pengolahan-produksi-mb" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/update_pengolahan_minyak_bumi_produksi') }}"
                class="form-material m-t-40" enctype="multipart/form-data" id="form_updatePengolahanProduksiMB">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
...
<div id="excelPengolahanMBProduksi" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/importPengolahanMBProduksi') }}" class="form-material m-t-40"
                ...
                <div class="modal-footer">
                    <a href="{{ url('/storage') }}/template/pengolahanMinyakBumi_ProduksiKilang.xlsx" id="tombol"
...
<div id="buat-pengolahan-pasokan-mb" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/simpan_pengolahan_minyak_bumi_pasokan') }}"
                class="form-material m-t-40" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control nama_kota" name="kabupaten_kota[]" id="kabupaten_kota"
...
<div id="edit-pengolahan-pasokan-mb" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/update_pengolahan_minyak_bumi_pasokan') }}"
                class="form-material m-t-40" enctype="multipart/form-data" id="form_updatePengolahanPasokanMB">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
...
<div id="excelPengolahanMBPasokan" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/importPengolahanMBPasokan') }}" class="form-material m-t-40"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    <a href="{{ url('/storage') }}/template/pengolahanMinyakBumi_PasokanKilang.xlsx" id="tombol"
                        class="btn btn-success waves-effect waves-light">Download Template</a>
                    <button type="button" class="btn btn-secondary waves-effect"
                        data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary waves-effect waves-light">Simpan</button>
...
<div id="buat-pengolahan-distribusi-mb" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/simpan_pengolahan_minyak_bumi_distribusi') }}"
                class="form-material m-t-40" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
...
<div id="edit-pengolahan-distribusi-mb" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/update_pengolahan_minyak_bumi_distribusi') }}"
                class="form-material m-t-40" enctype="multipart/form-data" id="form_updatePengolahanDistribusiMB">
                @method('PUT')
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
...
<div id="excelPengolahanMBDistribusi" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="{{ url('/importPengolahanMBDistribusi') }}" class="form-material m-t-40"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                    <a href="{{ url('/storage') }}/template/pengolahanMinyakBumi_DistribusiKilang.xlsx" id="tombol"
                        class="btn btn-success waves-effect waves-light">Download Template</a>
                    <button type="button" class="btn btn-secondary waves-effect"
                        data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary waves-effect waves-light">Simpan</button>
