            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">Laporan Hasil Olahan/Minyak Bumi</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Penjualan Hasil Olahan/Minyak Bumi" />
                                    </div>
                                </div>
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($penjualan as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/show/hasil-olahan/minyak-bumi') }}/{{ $id }}/penjualan">
                                                            {{ getBUlan($data->bulan) }}
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/show/hasil-olahan/minyak-bumi') }}/{{ $idTahun }}/penjualan">
                                                            {{ getTahun($data->bulan) }}
                                                            <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <form
                                                                action="{{ url('/hapus_bulan_jholb') }}/{{ $id }}"
                                                            ...
                                                            <form
                                                                action="{{ url('/submit_bulan_jholb') }}/{{ $id }}"
                                                                method="post" class="d-inline"
                                                                data-id="{{ $data->bulan }}">
                                                                @method('PUT')
                                                                @csrf
                                                            ...
                                                            <a href="{{ url('/show/hasil-olahan/minyak-bumi') }}/{{ $id }}/penjualan"
                            ...
                            <div class="row w-100">
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex justify-content-end gap-2">
                                        <a type="button" class="btn btn-sm btn-primary"
                                            onclick="produk(); provinsi(); sektor();" data-bs-toggle="modal"
                                            data-bs-target="#inputpho">
                                            <i class="fas fa-plus"></i> Buat Laporan
                                        </a>
                                        <a type="button" class="btn btn-sm btn-success" data-bs-toggle="modal"
                                            data-bs-target="#excelpholb">
                                            <i class="fas fa-upload"></i> Import Excel
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="card-body p-3">
                            <div class="card">
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Pasokan Hasil Olahan/Minyak Bumi" />
                                    </div>
                                </div>
                                <div class="card-body p-2">
                                    <table class="kt-datatable table table-bordered table-hover">
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            @foreach ($pasok as $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="{{ url('/show/hasil-olahan/minyak-bumi') }}/{{ $id }}/pasok">
                                                            {{ getBUlan($data->bulan) }}
                                                            <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="{{ url('/show/hasil-olahan/minyak-bumi') }}/{{ $idTahun }}/pasok">
                                                            {{ getTahun($data->bulan) }}
                                                            <i class="ki-solid ki-check" title="lihat data laporan"></i>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @else
                                                            <form
                                                                action="{{ url('/hapus_bulan_pasokan') }}/{{ $id }}"
                                                                method="post" class="d-inline">
                                                                @method('delete')
                                                                @csrf
                                                                <button type="button"
                                                            ...
                                                            <form
                                                                action="{{ url('/submit_bulan_pasokan-olah') }}/{{ $id }}"
                                                            ...
                                                            <a href="{{ url('/show/hasil-olahan/minyak-bumi') }}/{{ $id }}/pasok"
                                                                class="btn btn-icon btn-sm btn-info mb-2">
                                                                <i class="ki-solid ki-pencil"
                                                                    title="Detail / Edit Data"></i>
                                                            </a>
