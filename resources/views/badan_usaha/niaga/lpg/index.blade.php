                                    ...
                                    <tbody>
                                        @foreach ($lpgpenjualan as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td><b><a href="{{ url('/niaga/lpg/show') }}/{{ $id }}/penjualan">{{ getBulan($data->bulan) }}<i
                                                                class="bx bx-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td><b><a
                                                            href="{{ url('/niaga/lpg/show') }}/{{ $id }}/penjualan/tahun">{{ getTahun($data->bulan) }}<i
                                                                class="bx bx-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td>
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        @foreach ($lpgasok as $data)
                                            ...
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td><b><a href="{{ url('/niaga/lpg/show') }}/{{ $id }}/pasok">{{ getBulan($data->bulan) }}<i
                                                                class="bx bx-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td><b><a
                                                            href="{{ url('/niaga/lpg/show') }}/{{ $id }}/pasok/tahun">{{ getTahun($data->bulan) }}<i
                                                                class="bx bx-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td>
                                                    @if ($data->status_tertinggi == 1 && $data->catatanx)
