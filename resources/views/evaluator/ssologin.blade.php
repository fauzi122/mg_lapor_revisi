            ...
            <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
                <div class="w-full sm:max-w-sm mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="py-8">
                            <center>
                            <img src="{{ asset('assets/images/logo-esdm.png') }}" alt="Kementerian ESDM Logo" height="110" width="75">
                                <span class="text-2xl font-semibold">Single Sign On<br>Kementerian ESDM</span>
                            </center>
                        </div>
