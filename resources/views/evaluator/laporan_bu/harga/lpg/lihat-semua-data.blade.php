                                        ...
                                        <div class="modal fade modal-select" id="kt_modal_filter" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content rounded">
                                                    ...
                                                    <form action="{{ url('laporan/harga-lpg-lihat-semua-data') }}"
                                                        method="post">
                                                        @csrf
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($pgb->status == 1)
                                                        ...
                                                        @if ($pgb->status == 1 && $pgb->catatan)
                                                            <button class="btn btn-icon btn-sm btn-info mb-2 btn-selesai"
                                        ...
                                        <tbody>
                                            @foreach ($query as $pgb)
                                                <tr>
                                                    ...
                                                    <td>{{ $pgb->nama_perusahaan }}</td>
                                                    <td>{{ $pgb->nomor_izin }}</td>
                                                    <td>{{ \Carbon\Carbon::parse($pgb->tgl_pengajuan)->format('Y-m-d') }}
                                                    </td>
