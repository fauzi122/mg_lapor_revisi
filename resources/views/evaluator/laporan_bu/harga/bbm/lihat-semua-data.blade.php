                                ...
                                <div class="modal fade modal-select" id="kt_modal_filter" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <form action="{{ url('laporan/harga-bbm-lihat-semua-data') }}"
                                            method="post">
                                                @csrf
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Harga BBM JBU {{ $periode }}" />
                            </div>
                        </div>
                                                ...
                                                <div class="modal fade" id="modal-update"
                                                    ...
                                                    <div class="modal-dialog modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <form
                                                                action="{{ url('/laporan/harga-bbm/update-revision') }}"
