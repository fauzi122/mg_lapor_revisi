                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Harga BBM JBU {{ $per->nama_perusahaan }}" />
                                    </div>
                                </div>
                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        @foreach ($query as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <b><a href="{{ url('/laporan/harga-bbm') }}/{{ $kodeBulan }}">{{ getBulan($data->bulan) }}
                                                            <i class="bi bi-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td>
                                                    <b><a href="{{ url('/laporan/harga-bbm') }}/{{ $kodeTahun }}">{{ getTahun($data->bulan) }}
                                                            <i class="bi bi-check" title="lihat data laporan"></i></a><b>
                                                </td>
                                                <td>
                                                        ...
                                                        <div class="modal fade"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                                ...
                                                                <div class="modal-content rounded">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('/laporan/harga-bbm/update-revision-all') }}"
