        ...
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    ...
                    <li class="breadcrumb-item text-muted">Laporan Impor</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-start">
                                <h4>
                                    @if ($mode === 'tahun')
                                        Periode Tahun {{ getTahun($per->bulan_pib) }} - {{ $per->nama_perusahaan ?? '-' }}
                                    @else
                                        Periode Bulan {{ dateIndonesia($per->bulan_pib) }} - {{ $per->nama_perusahaan ?? '-' }}
                                    @endif
                                </h4>                                
                            </div>
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('laporan/impor/exim/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Impor {{ dateIndonesia($per->bulan_pib) }} {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                                                            ...
                                                            <div class="modal fade" id="modal-update"
                                                                ...
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('/laporan/impor/exim/update-revision') }}"
