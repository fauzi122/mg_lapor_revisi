            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">Ekspor</li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                                        ...
                                        <div class="modal fade modal-select" id="kt_modal_filter" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                ...
                                                <div class="modal-content rounded">
                                                    ...
                                                    <form action="{{ url('laporan/expor/exim-lihat-semua-data') }}"
                                                        method="post">
                                                        @csrf
                                                            ...
                                                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <label for="example-text-input"
                                                                        ...
                                                                        <span>Tanggal Awal (Bulan yang dilaporkan)</span>
                                                                ...
                                                                <div class="fv-row mb-7">
                                                                    <label for="example-text-input"
                                                                        class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                                        <span>Tanggal Akhir (Bulan yang dilaporkan)</span>
                                                                    </label>
                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Penyimpanan Gas Bumi {{ $periode }}" />
                                    </div>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($pgb->status == 1)
                                                        ...
                                                        <!-- Modal Update -->
                                                        <div class="modal fade modal-select" id="kt_modal_update"
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <h4>Periode {{ $periode }}</h4>
                                    <div>
                                        <a href="{{ url('laporan/expor/exim-lihat-semua-data') }}"
                                            class="btn btn-danger waves-effect waves-light">
