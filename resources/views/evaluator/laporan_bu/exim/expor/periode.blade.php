                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Ekspor {{ $per->nama_perusahaan }}" />
                                    </div>
                                </div>
                                                ...
                                                @if ($data->status == 1)
                                                    <td class="text-center">
                                                        <button type="button"
                                                            ...
                                                            data-bs-target="#kt_modal_update_{{ getBulan($data->bulan_peb) }}"
                                                            title="Revisi data">
                                                        ...
                                                        @if ($data->status == 1 && $data->catatan)
                                                            <button
                                                                ...
                                                                data-b="{{ \Illuminate\Support\Facades\Crypt::encrypt($data->bulan_peb) }}"><i
                                                                    class="bi bi-check" title="Selesai"></i></button>
                                                        @endif

                                                        <div class="modal fade"
                                                            id="kt_modal_update_{{ getBulan($data->bulan_peb) }}"
