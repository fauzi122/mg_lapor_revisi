                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-start">
                                <h4>
                                    @if ($mode === 'tahun')
                                        Periode Tahun {{ getTahun($per->bulan_peb) }} - {{ $per->nama_perusahaan ?? '-' }}
                                    @else
                                        Periode Bulan {{ dateIndonesia($per->bulan_peb) }} - {{ $per->nama_perusahaan ?? '-' }}
                                    @endif
                                </h4>                                
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Harga LPG {{ dateIndonesia($per->bulan_peb) }} {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                                                        ...
                                                        <div class="modal-content rounded">
                                                            ...
                                                            <form action="{{ url('/laporan/expor/exim/update-revision') }}"
                                                                ...
                                                                <div class="modal-body py-3 px-lg-17">
                                                                    ...
                                                                    <div class="mb-7">
                                                                        <label for="catatan_{{ $pgb->id }}" class="form-label">Notes</label>
                                                                        <textarea name="catatan" id="catatan_{{ $pgb->id }}" rows="5"
