                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="cetakForm"
                                                        action="{{ url('laporan/expor/exim/cetak-periode') }}"
                                                        method="post">
                                                        @csrf
                                                        <div>
                                                            <div class="mb-3">
                                ...
                                <div class="modal fade modal-select bs-example-modal-center" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm" action="{{ url('laporan/expor/exim/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
                                            ...
                                            <tbody>
                                                @foreach ($perusahaan as $per)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ url('laporan/expor/exim/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
                                                                class="btn btn-primary btn-rounded btn-sm"><i
