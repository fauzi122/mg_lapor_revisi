                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pengangkutan Minyak Bumi {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($query as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b><a href="{{ url('/laporan/pengangkutan/mb') }}/{{ $kodeBulan }}">
                                                {{ getBulan($data->bulan) }}
                                                <i class="bi bi-check" title="Lihat laporan per bulan"></i>
                                            </a></b>
                                        </td>
                                        <td>
                                            <b><a href="{{ url('/laporan/pengangkutan/mb') }}/{{ $kodeTahun }}">
                                                {{ getTahun($data->bulan) }}
