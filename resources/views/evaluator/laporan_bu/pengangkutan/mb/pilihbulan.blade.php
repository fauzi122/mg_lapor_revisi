                            ...
                            <div class="row w-100">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        @endphp
                                        <a href="{{ url('laporan/pengangkutan/mb/periode') . '/' . $kode }}"
                                ...
                                <table class="kt-datatable table table-bordered table-hover">
                                    <thead class="bg-light">
                                        <tr class="fw-bold text-uppercase">
                                            ...
                                            <th style="text-align: center; vertical-align: middle;">Jenis Moda</th>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="{{ url('laporan/pengangkutan/mb/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
