                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pengangkutan Gas Bumi {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($query as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b><a href="{{ url('/laporan/pengangkutan/gb') }}/{{ $kodeBulan }}">
                                                {{ getBulan($data->bulan) }}
                                                <i class="bi bi-check" title="Lihat laporan per bulan"></i>
                                            </a></b>
                                        </td>
                                        <td>
                                            <b><a href="{{ url('/laporan/pengangkutan/gb') }}/{{ $kodeTahun }}">
                                                {{ getTahun($data->bulan) }}
                                                ...
                                                <tbody>
                                                    @foreach ($query as $data)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <b><a
                                                                        href="{{ url('/laporan/pengangkutan/gb') }}/{{ $kodeBulan }}">{{ getBulan($data->bulan) }}
                                                                        <i class="bx bx-check"
                                                                            title="lihat data laporan"></i></a><b>
                                                            </td>
                                                            <td>
                                                                <b><a
                                                                        href="{{ url('/laporan/pengangkutan/gb') }}/{{ $kodeTahun }}">{{ getTahun($data->bulan) }}
                                                                        <i class="bx bx-check"
                                                                            title="lihat data laporan"></i></a><b>
                                                            </td>
                                                            <td>
                                                                    ...
                                                                    <div class="modal fade" id="modal-update"
                                                                        ...
                                                                        <div class="modal-dialog modal-lg">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <form
                                                                                    action="{{ url('/laporan/pengangkutan/gb/update-revision-all') }}"
                                                                                    method="post" id="updateStatusForm"
                                                                                    enctype="multipart/form-data">
                                                                                    @csrf
                                                                                    <input type="hidden" name="p"
