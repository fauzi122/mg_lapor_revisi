            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">Gas Bumi</li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                            ...
                            <div class="row w-100">
                                <div class="col-12">
                                    ...
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        @endphp
                                        <a href="{{ url('laporan/pengangkutan/gb/periode') . '/' . $kode }}"
                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Pengangkutan Minyak Bumi {{ dateIndonesia($per->bulan) }} {{ $per->nama_perusahaan }}" />
                                    </div>
                                </div>
                                <table class="kt-datatable table table-bordered table-hover">
                                    <thead class="bg-light">
                                        <tr class="fw-bold text-uppercase">
                                            ...
                                            <th style="text-align: center; vertical-align: middle;">Node Asal</th>
                                            <th style="text-align: center; vertical-align: middle;">Provinsi Asal</th>
                                            <th style="text-align: center; vertical-align: middle;">Aksi</th>
                                            <th style="text-align: center; vertical-align: middle;">Node Tujuan</th>
                                            <th style="text-align: center; vertical-align: middle;">Provinsi Tujuan</th>
                                            <th style="text-align: center; vertical-align: middle;">Volume Supply</th>
                                            <th style="text-align: center; vertical-align: middle;">Satuan Volume Supply
                                            </th>
                                            <th style="text-align: center; vertical-align: middle;">Volume Angkut</th>
                                            <th style="text-align: center; vertical-align: middle;">Satuan Volume Angkut
                                            </th>
                                                        ...
                                                        <div class="modal fade" id="kt_modal_update_{{ $pgb->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                                ...
                                                                <div class="modal-content rounded">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('/laporan/pengangkutan/gb/update-revision') }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="{{ url('laporan/pengangkutan/gb/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
