                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pengangkutan Minyak Bumi {{ dateIndonesia($per->bulan) }} {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                        <table class="kt-datatable table table-bordered table-hover">
                            <thead class="bg-light">
                                <tr class="fw-bold text-uppercase">
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Satuan Volume Supply</th>
                                    <th style="text-align: center; vertical-align: middle;">Volume Angkut</th>
                                    <th style="text-align: center; vertical-align: middle;">Satuan Volume Angkut</th>
