                        ...
                        <div class="row w-100">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ url('/laporan/sinkronisasi-data/kuota-jbt') }}"
                                    ...
                                    <a href="{{ url('/laporan/kuota-jbt-lihat-semua-data') }}"
                                    ...
                                    <div class="modal fade" id="kt_modal_cetak" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <form action="{{ url('/laporan/kuota-jbt/cetak-periode') }}" method="post">
                                                    @csrf
                        ...
                        <div class="card">
                            <div class="card-header align-items-center px-2">
                                ...
                                <div class="card-title flex-row-fluid justify-content-end gap-5">
                                    <input type="hidden" class="export-title" value="Laporan JBT Kuota" />
                                </div>
                            </div>
                                    ...
                                    @foreach ($perusahaan as $per)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('laporan/kuota-jbt/periode/' . Crypt::encryptString($per->npwp_badan_usaha)) }}"
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.Echo.connector.pusher.connection.bind('connected', () => {
                ...
                Echo.private(`jobs.session.${sessionId}.jbt-kuota`)
