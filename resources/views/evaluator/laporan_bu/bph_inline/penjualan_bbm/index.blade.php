                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                                                    ...
                                                    <form id="cetakForm" action="{{ url('/laporan/penjualan-bbm/cetak-periode') }}" method="post">
                                                    @csrf
                                                        <div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Penjualan BBM" />
                            </div>
                        </div>
                                ...
                                @foreach ($perusahaan as $per)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('laporan/penjualan-bbm/periode/' . Crypt::encryptString($per->npwp_badan_usaha)) }}"
