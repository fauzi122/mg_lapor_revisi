                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ url('/laporan/penjualan-bbm') }}" class="btn btn-danger btn-sm btn-rounded">
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Penjualan BBM {{ $per->nama_badan_usaha }}" />
                            </div>
                        </div>
                                ...
                                @foreach ($query as $i => $row)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/laporan/penjualan-bbm') }}/{{ $params }}"
