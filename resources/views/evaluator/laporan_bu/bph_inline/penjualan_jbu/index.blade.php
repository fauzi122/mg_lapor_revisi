                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('/laporan/sinkronisasi-data/penjualan-jbu') }}"
                                ...
                                <a href="{{ url('/laporan/penjualan-jbu-lihat-semua-data') }}"
                                ...
                                <div class="modal fade" id="kt_modal_cetak" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            <!--begin::Modal header-->
                                            <div class="modal-header" id="kt_modal_cetak_header">
                                                <!--begin::Modal title-->
                                                <h2 class="fw-bold">Cetak</h2>
                                                <!--end::Modal title-->
                                                <!--begin::Close-->
                                                <div id="kt_modal_cetak_close" class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal">
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                                                    ...
                                                    <form id="cetakForm" action="{{ url('/laporan/penjualan-jbu/cetak-periode') }}" method="post">
                                                    @csrf
                                                        <div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Penjualan JBU" />
                            </div>
                        </div>
                                ...
                                @foreach ($perusahaan as $per)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('laporan/penjualan-jbu/periode/' . Crypt::encryptString($per->npwp_badan_usaha)) }}"
                                                class="btn btn-primary btn-rounded btn-sm" class="text-center">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm"
                                                    action="{{ url('/laporan/penjualan-jbu/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
