                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('/laporan/sinkronisasi-data/pasokan-gas-bumi') }}"
                                ...
                                <a href="{{ url('/laporan/pasokan-gas-bumi-lihat-semua-data') }}"
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                                                    ...
                                                    <form id="cetakForm" action="{{ url('/laporan/pasokan-gas-bumi/cetak-periode') }}" method="post">
                                                    @csrf
                                                        <div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pasokan Gas Bumi" />
                            </div>
                        </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($perusahaan as $per)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('laporan/pasokan-gas-bumi/periode/' . Crypt::encryptString($per->npwp_badan_usaha)) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm"
                                                    action="{{ url('/laporan/pasokan-gas-bumi/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
