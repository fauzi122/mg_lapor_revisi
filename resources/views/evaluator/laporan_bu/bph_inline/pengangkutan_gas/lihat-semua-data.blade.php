                                ...
                                <div class="modal fade" id="kt_modal_filter" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <form action="{{ url('laporan/pengangkutan-gas-lihat-semua-data') }}" method="post">
                                                @csrf
                                                <div class="modal-body py-10 px-lg-17">
                                                    ...
                                                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <input class="form-control" name="t_awal" type="month" required>
                                                        </div>
                                                        <div class="fv-row mb-7">
                                                            <label for="example-text-input" class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                            ...
                                                            <input class="form-control" name="t_akhir" type="month" required>
                                                        </div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pengangkutan {{ $periode }}" />
                            </div>
                        </div>
                        <table class="kt-datatable table table-bordered table-hover">
                            <thead class="bg-light">
                                <tr class="fw-bold text-uppercase">
                                    ...
                                    <th class="text-center">Ruas Angkut</th>
                                    <th class="text-center">Diameter</th>
                                    <th class="text-center">Shipper</th>
                                    <th class="text-center">Tarif MSCF</th>
                                    <th class="text-center">Volume MSCF</th>
                                    <th class="text-center">Satuan MSCF</th>
                                </tr>
                            </thead>
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($query as $pg)
                                    <tr>
                                        ...
                                        <td>{{ $pg->nama_badan_usaha }}</td>
                                        <td>{{ $pg->npwp_badan_usaha }}</td>
                                        <td>
                                            @php
                                                $izinList = json_decode($pg->izin_usaha, true); // jika izin_usaha disimpan dalam bentuk JSON string
                                            @endphp
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ url('laporan/pengangkutan-gas-lihat-semua-data') }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="mb-3">
