            ...
            <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url('/laporan/pengangkutan-gas') }}" class="text-muted text-hover-primary">Laporan
                                Pengangkutan Gas</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                                    ...
                                    <div class="modal fade" id="kt_modal_filter" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <form action="{{ url('laporan/pengangkutan-gas-lihat-semua-data') }}"
                                                    method="GET">
                                                    @csrf
                        ...
                        <div class="card">
                            <div class="card-header align-items-center px-2">
                                ...
                                <div class="card-toolbar">
                                    <form method="GET" action="{{ url('laporan/pengangkutan-gas-lihat-semua-data') }}" class="d-flex" role="search">
