        ...
        <tbody>
            @foreach ($result as $laporan)
                <tr>
                    ...
                    <td style="border: 1px solid black;">{{ $laporan->produk }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->provinsi }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->kabupaten_kota }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->sektor }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->volume }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->satuan }}</td>
