                        ...
                        <div class="row w-100">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ url('/laporan/sinkronisasi-data/penjualan-jbt') }}"
                                    ...
                                    <a href="{{ url('/laporan/penjualan-jbt-lihat-semua-data') }}"
                                    ...
                                    <div class="modal fade" id="kt_modal_cetak" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <form action="{{ url('/laporan/penjualan-jbt/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                        ...
                        <div class="card">
                            <div class="card-header align-items-center px-2">
                                ...
                                <div class="card-title flex-row-fluid justify-content-end gap-5">
                                    <input type="hidden" class="export-title" value="Laporan Penjualan JBT" />
                                </div>
                            </div>
                                    ...
                                    @foreach ($perusahaan as $per)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('laporan/penjualan-jbt/periode/' . Crypt::encryptString($per->npwp_badan_usaha)) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm"
                                                    action="{{ url('/laporan/penjualan-jbt/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
...
@section('script')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // window.Echo.connector.pusher.connection.bind('connecting', () => console.log('Echo connecting...'));
            // window.Echo.connector.pusher.connection.bind('disconnected', () => console.log('Echo disconnected'));
            // window.Echo.connector.pusher.connection.bind('error', (err) => console.error('Echo connection error:',
            //     err));
        });
    </script>
@endsection
