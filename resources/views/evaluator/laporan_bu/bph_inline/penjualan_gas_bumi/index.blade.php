                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('/laporan/sinkronisasi-data/penjualan-gas-bumi') }}"
                                ...
                                <a href="{{ url('/laporan/penjualan-gas-bumi-lihat-semua-data') }}"
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                ...
                                                <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                                                    ...
                                                    <form id="cetakForm" action="{{ url('/laporan/penjualan-gas-bumi/cetak-periode') }}" method="post">
                                                    @csrf
                                                        <div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Penjualan Gas Bumi" />
                            </div>
                        </div>
                                ...
                                @foreach ($perusahaan as $per)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('laporan/penjualan-gas-bumi/periode/' . Crypt::encryptString($per->npwp_badan_usaha)) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm"
                                                    action="{{ url('/laporan/penjualan-gas-bumi/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
