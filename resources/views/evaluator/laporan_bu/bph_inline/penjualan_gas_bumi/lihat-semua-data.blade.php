                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ url('/laporan/penjualan-gas-bumi') }}"
                                class="text-muted text-hover-primary">Penjualan Gas Bumi</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-400 w-5px h-2px"></span>
                        </li>
                                    ...
                                    <div class="modal fade" id="kt_modal_filter" tabindex="-1" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <form action="{{ url('laporan/penjualan-gas-bumi-lihat-semua-data') }}"
                                                    method="GET">
                                                    @csrf
                        ...
                        <div class="card">
                            <div class="card-header align-items-center px-2">
                                ...
                                <div class="card-toolbar">
                                    <form method="GET" action="{{ url('laporan/penjualan-gas-bumi-lihat-semua-data') }}" class="d-flex" role="search">
