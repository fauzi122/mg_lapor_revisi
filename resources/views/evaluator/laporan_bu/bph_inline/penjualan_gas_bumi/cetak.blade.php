    ...
    <table class="table table-light" style="font-size: 12px; border-collapse: collapse; border: 1px solid black;">
        <thead style="background-color: #f2f2f2;">
            <tr>
                ...
                <th style="border: 1px solid black;">SATUAN MMBTU</th>
                <th style="border: 1px solid black;">HARGA MMBTU</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($result as $laporan)
                <tr>
                    ...
                    <td style="border: 1px solid black;">{{ $laporan->provinsi }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->kabkot }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->sektor }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->konsumen }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->jml_hari_penyaluran }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->ghv }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->keterangan }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->volume_mmbtu }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->satuan_mmbtu }}</td>
                    <td style="border: 1px solid black;">{{ $laporan->harga_mmbtu }}</td>
