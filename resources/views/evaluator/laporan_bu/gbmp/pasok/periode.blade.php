        ...
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    ...
                    <li class="breadcrumb-item text-muted">Pasokan Gas Bumi</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($query as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b><a
                                                    href="{{ url('/laporan/pasok/gbmp') }}/{{ $kodeBulan }}">{{ getBulan($data->bulan) }}
                                                    <i class="bi bi-check"
                                                        title="lihat data laporan"></i></a><b>
                                        </td>
                                        <td>
                                            <b><a
                                                    href="{{ url('/laporan/pasok/gbmp') }}/{{ $kodeTahun }}">{{ getTahun($data->bulan) }}
                                                    <i class="bi bi-check"
                                                        title="lihat data laporan"></i></a><b>
                                        </td>
                                        <td>
                                                ...
                                                <tbody>
                                                    @foreach ($query as $data)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <b><a
                                                                        href="{{ url('/laporan/pasok/gbmp') }}/{{ $id }}">{{ getBulan($data->bulan) }}
                                                                        <i class="bx bx-check"
                                                                            title="lihat data laporan"></i></a><b>
                                                            </td>
                                                            <td>
                                                                <b><a
                                                                        href="{{ url('/laporan/pasok/gbmp') }}/{{ $idTahun }}">{{ getTahun($data->bulan) }}
                                                                        <i class="bx bx-check"
                                                                            title="lihat data laporan"></i></a><b>
                                                            </td>
                                                            <td>
                                                                    ...
                                                                    <div class="modal fade" id="modal-update"
                                                                        ...
                                                                        <div class="modal-dialog modal-lg">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <form
                                                                                    action="{{ url('/laporan/pasok/gbmp/update-revision-all') }}"
                                                                                    method="post" id="updateStatusForm"
                                                                                    enctype="multipart/form-data">
                                                                                    @csrf
                                                                                    <input type="hidden" name="p"
