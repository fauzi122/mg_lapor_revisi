                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('laporan/jual/gbmp/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Penjualan Gas Bumi {{ dateIndonesia($per->bulan) }} {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                        <table class="kt-datatable table table-bordered table-hover">
                            <thead class="bg-light">
                                <tr class="fw-bold text-uppercase">
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">Jumlah Hari Penyaluran</th>
                                    <th style="text-align: center; vertical-align: middle;">GHV</th>
                                                            ...
                                                            <div class="modal fade" id="modal-update"
                                                                ...
                                                                <div class="modal-dialog modal-lg">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form
                                                                            action="{{ url('/laporan/jual/gbmp/update-revision') }}"
                                                                            method="post" id="updateStatusForm"
                                                                            enctype="multipart/form-data">
                                                                            @csrf
                                                                            <input type="hidden" name="id"
