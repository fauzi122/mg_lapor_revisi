                        ...
                        <div class="row w-100">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <a href="{{ url('/laporan/pasokan/mb-lihat-semua-data') }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="cetakForm"
                                                        action="{{ url('laporan/pasokan/mb/cetak-periode') }}"
                                                        method="post">
                                                        @csrf
                                                        <div>
                                                            <div class="mb-3">
                                    ...
                                    @foreach ($perusahaan as $per)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                <a href="{{ url('laporan/pasokan/mb/periode') . '/' . $kode }}"
                                ...
                                <div class="modal fade modal-select bs-example-modal-center" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm" action="{{ url('laporan/pasokan/mb/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
                                            ...
                                            <tbody>
                                                @foreach ($perusahaan as $per)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ url('laporan/pasokan/mb/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->id_perusahaan) }}"
