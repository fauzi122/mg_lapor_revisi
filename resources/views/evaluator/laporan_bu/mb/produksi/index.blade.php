                        ...
                        <div class="row w-100">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <a href="{{ url('/laporan/produksi/mb-lihat-semua-data') }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form id="cetakForm"
                                                        action="{{ url('laporan/produksi/mb/cetak-periode') }}"
                                                        method="post">
                                                        @csrf
                                                        <div>
                                                            <div class="mb-3">
                                            ...
                                            <td>
                                                @php
                                                    $kode = Crypt::encryptString(
                                                        $per->npwp . ',' . $per->id_permohonan,
                                                    );
                                                @endphp
                                                <a href="{{ url('laporan/produksi/mb/periode') . '/' . $kode }}"
                                                    class="btn btn-primary btn-rounded btn-sm"><i class="bi-eye fs-3"></i>
                                                    Lihat </a>
                                            </td>
                                ...
                                <div class="modal fade modal-select bs-example-modal-center" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm" action="{{ url('laporan/produksi/mb/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
                                            ...
                                            <tbody>
                                                @foreach ($perusahaan as $per)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ url('laporan/produksi/mb/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->id_perusahaan) }}"
