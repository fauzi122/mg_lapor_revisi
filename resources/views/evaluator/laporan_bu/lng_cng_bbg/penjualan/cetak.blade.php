        ...
        <tbody>
            @foreach ($result as $pgb)
                <tr>
                    ...
                    <td style="border: 1px solid black;">{{ $pgb->biaya_kompresi }}</td>
                    <!-- Change biaya_perolehan to biaya_kompresi -->
                    <td style="border: 1px solid black;">{{ $pgb->biaya_pengangkutan }}</td>
                    <!-- Add BIAYA PENGANGKUTAN -->
