                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('laporan/pasok/lng-cng-bbg/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pasokan LNG/CNG/BBG {{ dateIndonesia($per->bulan) }} {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
