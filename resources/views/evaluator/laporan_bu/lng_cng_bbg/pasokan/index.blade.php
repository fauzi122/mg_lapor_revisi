                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ url('/laporan/pasok/lng-cng-bbg-lihat-semua-data') }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm"
                                                    action="{{ url('laporan/pasok/lng-cng-bbg/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($perusahaan as $per)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('laporan/pasok/lng-cng-bbg/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
                                            ...
                                            <tbody>
                                                @foreach ($perusahaan as $per)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ url('laporan/pasok/lng-cng-bbg/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->id_perusahaan) }}"
                                                                class="btn btn-primary btn-rounded btn-sm"><i
