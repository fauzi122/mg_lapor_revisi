        ...
        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0">
                    ...
                    <li class="breadcrumb-item text-muted">Hasil Olahan/Minyak Bumi</li>
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
                    </li>
                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ url('laporan/pasokan-hasil-olahan') }}"
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pasokan Hasil Olahan/Minyak Bumi {{ $per->nama_perusahaan }}" />
                            </div>
                        </div>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($query as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b><a
                                                    href="{{ url('/laporan/pasokan-hasil-olahan') }}/{{ $kodeBulan }}">{{ getBulan($data->bulan) }}
                                                    <i class="bi bi-check"
                                                        title="lihat data laporan"></i></a><b>
                                        </td>
                                        <td>
                                            <b><a
                                                    href="{{ url('/laporan/pasokan-hasil-olahan') }}/{{ $kodeTahun }}">{{ getTahun($data->bulan) }}
                                                    <i class="bi bi-check"
                                                        title="lihat data laporan"></i></a><b>
                                        </td>
                                        <td>
                                        ...
                                        @if ($data->status == 1)
                                            <td class="text-center">
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#kt_modal_update_{{ getBulan($data->bulan) }}" title="Revisi data">
                                                ...
                                                <div class="modal fade" id="kt_modal_update_{{ getBulan($data->bulan) }}" tabindex="-1" aria-hidden="true">
                                                    <!--begin::Modal dialog-->
                                                ...
                                                <tbody>
                                                    @foreach ($query as $data)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <b><a
                                                                        href="{{ url('/laporan/pasokan-hasil-olahan') }}/{{ $id }}">{{ getBulan($data->bulan) }}
                                                                        <i title="lihat data laporan"></i></a><b>
                                                            </td>
                                                            <td>
                                                                <b><a
                                                                        href="{{ url('/laporan/pasokan-hasil-olahan') }}/{{ $idTahun }}">{{ getTahun($data->bulan) }}
                                                                        <i title="lihat data laporan"></i></a><b>
                                                            </td>
                                                            <td>
                                                                @if ($data->status == 1 && $data->catatan)
