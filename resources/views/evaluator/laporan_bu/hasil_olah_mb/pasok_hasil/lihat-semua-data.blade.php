                                ...
                                <div class="modal fade" id="kt_modal_filter" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content rounded">
                                            ...
                                            <form action="{{ url('laporan/pasokan-hasil-olahan-lihat-semua-data') }}"
                                            method="post">
                                                @csrf
                    ...
                    <div class="card">
                        <div class="card-header align-items-center px-2">
                            ...
                            <div class="card-title flex-row-fluid justify-content-end gap-5">
                                <input type="hidden" class="export-title" value="Laporan Pasokan Hasil Olahan/Minyak Bumi {{ $periode }}" />
                            </div>
                        </div>
                                        ...
                                        <div class="modal fade modal-select bs-example-modal-center" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form
                                                            action="{{ url('laporan/pasokan-hasil-olahan-lihat-semua-data') }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="mb-3">
