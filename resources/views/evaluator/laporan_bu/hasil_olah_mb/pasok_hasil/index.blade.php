                    ...
                    <div class="row w-100">
                        <div class="col-12">
                            <div class="d-flex justify-content-end gap-2">
                                ...
                                <a href="{{ url('/laporan/pasokan-hasil-olahan-lihat-semua-data') }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form id="cetakForm"
                                                    action="{{ url('laporan/pasokan-hasil-olahan/cetak-periode') }}"
                                                    method="post">
                                                    @csrf
                                                    <div>
                                                        <div class="mb-3">
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($perusahaan as $per)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('laporan/pasokan-hasil-olahan/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
                                                class="btn btn-primary btn-rounded btn-sm"><i
                                                    class="bi bi-eye fs-3"></i> Lihat </a></td>
                                            ...
                                            <tbody>
                                                @foreach ($perusahaan as $per)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{ url('laporan/pasokan-hasil-olahan/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->id_perusahaan) }}"
                                                                class="btn btn-primary btn-rounded btn-sm"><i
