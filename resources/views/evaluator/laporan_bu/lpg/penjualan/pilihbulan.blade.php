                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Penjualan LPG {{ dateIndonesia($per->bulan) }} {{ $per->nama_perusahaan }}" />
                                    </div>
                                </div>
                                <table class="kt-datatable table table-bordered table-hover">
                                    <thead class="bg-light">
                                        <tr class="fw-bold text-uppercase">
                                            ...
                                            <th style="text-align: center; vertical-align: middle;">Kemasan</th>
                                                        ...
                                                        <div class="modal fade" id="kt_modal_update_{{ $pgb->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                                ...
                                                                <div class="modal-content rounded">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('/laporan/jual/lpg/update-revision') }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="{{ url('laporan/jual/lpg/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
