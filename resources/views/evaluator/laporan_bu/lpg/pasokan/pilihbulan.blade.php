                                ...
                                <div class="card-header align-items-center px-2">
                                    ...
                                    <div class="card-title flex-row-fluid justify-content-end gap-5">
                                        <input type="hidden" class="export-title"
                                            value="Laporan Pasokan LPG {{ dateIndonesia($per->bulan) }} {{ $per->nama_perusahaan }}" />
                                    </div>
                                </div>
                                                        ...
                                                        <div class="modal fade" id="kt_modal_update_{{ $pgb->id }}"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered mw-650px">
                                                                ...
                                                                <div class="modal-content rounded">
                                                                    ...
                                                                    <form
                                                                        action="{{ url('/laporan/pasok/lpg/update-revision') }}"
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <a href="{{ url('laporan/pasok/lpg/periode') . '/' . \Illuminate\Support\Facades\Crypt::encrypt($per->npwp) }}"
