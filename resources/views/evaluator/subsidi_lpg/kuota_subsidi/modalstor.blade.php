    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-header" id="kt_modal_new_target_header">
                <!--begin::Modal title-->
                <h2 class="fw-bold">Tambah Data Kuota LPG Subsidi Verified</h2>
                <!--end::Modal title-->
                <!--begin::Close-->
            ...
            <form action="{{ url('/lpg/kuota/store') }}" method="post" id="myform" enctype="multipart/form-data">
                @csrf
                <div class="modal-body py-10 px-lg-17">
                    ...
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_new_target_scroll"
                        ...
                        <div class="fv-row mb-7">
                            <label for="kabkot" class="d-flex align-items-center fs-6 fw-semibold mb-2">
