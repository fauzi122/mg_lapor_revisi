                                    ...
                                    @foreach ($roles as $no => $role)
                                        <tr>
                                            ...
                                            <td>
                                                @foreach ($role->getPermissionNames() as $permission)
                                                    @if (Str::contains($permission, '_ujian'))
                                                        <button
                                                            class="btn btn-sm btn-warning mb-1 mt-1 mr-1">{{ $permission }}</button>
                                                    @endif
                                                @endforeach
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <form action="{{ url('/role/destroy') }}/{{ $role->id }}" method="post"
                                                    class="d-none">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="button" onclick="hapusData($(this).closest('form'))"
