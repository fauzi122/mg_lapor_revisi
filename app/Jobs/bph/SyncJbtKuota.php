...
class SyncJbtKuota implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            KuotaJbt::where('tahun', $this->tahun)->delete();
            
            while (true) {

                $response = $api->post('/bbm/kuota-jbt', $this->tahun, $page);
            ...
            if ($this->sessionId) {
                broadcast(new BphSyncNotification("Sinkronisasi JBT Kuota selesai.", $this->sessionId, "jbt-kuota"));
            }
        } catch (\Throwable $e) {
            ...
            if ($this->sessionId) {
                broadcast(new BphSyncNotification("Sinkronisasi JBT Kuota gagal", $this->sessionId, "jbt-kuota"));
            }
