...
use App\Exports\PenjualanJbkpKuotaExport;
...
class EvKuotaJbkp extends Controller
{
    
    public function index()
    {
        $perusahaan = KuotaJbkp::select('id_badan_usaha', 'izin_usaha','nama_badan_usaha','npwp_badan_usaha') 
        ...
        $data = [
            'title' => 'Laporan JBKP Kuota',
            'perusahaan' => $perusahaan,
        ];
        // dd($perusahaan);
        return view('evaluator.laporan_bu.bph_inline.kuota_jbkp.index', $data);
    }
    ...
    public function periode($kode = '')
    {
        ...
        if ($p) {
            ...
            $query = KuotaJbkp::select('nama_badan_usaha', 'tahun', 'npwp_badan_usaha',DB::raw('MIN(id) as id')) 
...
// dd($query);
    ...
    //   dd($query);
        return view('evaluator.laporan_bu.bph_inline.kuota_jbkp.periode', $data);
    }
    ...
    public function show($kode = '', Request $request)
    {
        ...
        if ($request->filled('export')) {
            $export = new PenjualanJbkpKuotaExport($query, $request->export);
        ...
        return view('evaluator.laporan_bu.bph_inline.kuota_jbkp.pilihbulan', $data);
    ...
    public function sinkronisasiData() 
    {
        ...
        $url = "https://ngembangin.esdm.go.id/inline/hilir/internal/api/dev/pelaporan-migas/bbm/kuota-jbkp";
    ...
    public function cetakperiode(Request $request)
    {
        ...
        $export = new PenjualanJbkpKuotaExport($query, 'xlsx');
    ...
    public function lihatSemuaData(Request $request)
    {
        ...
        $query = KuotaJbkp::where('tahun', $tahun);
        ...
        $perusahaan  = KuotaJbkp::select('npwp_badan_usaha', 'nama_badan_usaha')
        ...
        return view('evaluator.laporan_bu.bph_inline.kuota_jbkp.lihat-semua-data', [
            'title'     => 'Laporan JBKP Kuota',
            'query'     => $query,
            'periode'   => $periode,
            'perusahaan'=> $perusahaan,
