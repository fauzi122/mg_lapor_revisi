...
class EvPenjualanJbu extends Controller
{
    ...
    {
        $perusahaan = DB::table('bph_penjualan_jbu')
    ...
    public function show($kode = '')
    {
        ...
        $query = DB::table('bph_penjualan_jbu as a')
            ->select('a.*')
            ->get();
...
//        var_dump($query);die();
    ...
    public function updateRevisionNotes(Request $request)
    {
        ...
        $update = PenjualanJbu::where('id', $id)
            ->update([
    ...
    public function updateRevisionNotesAll(Request $request)
    {
        ...
        $update = PenjualanJbu::where('badan_usaha_id', $badan_usaha_id)
            ->where('bulan',$bulan)
    ...
    public function lihatSemuaData()
    {
        ...
        $perusahaan = DB::table('bph_penjualan_jbu as a')
        ->leftJoin('t_perusahaan as b', 'a.id_badan_usaha', '=', 'b.ID_PERUSAHAAN')
        ->leftJoin('r_permohonan_izin as c', 'b.ID_PERUSAHAAN', '=', 'c.ID_PERUSAHAAN')
        ->whereIn('a.status', [1, 2, 3])
