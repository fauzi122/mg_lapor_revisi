...
class EvBphPengangkutanGas extends Controller
{
    ...
    public function sinkronisasiData() 
    {
        ...
        $url = "https://ngembangin.esdm.go.id/inline/hilir/internal/api/dev/pelaporan-migas/gas/pengangkutan-gas";
            ...
            foreach ($items as $item) {
                BphPengangkutanGas::updateOrCreate(
                    ...
                    [
                        ...
                        'shipper'           => $item['shipper'],
                        'tarif_mscf'        => $item['tarif_mscf'],
                        'volume_mscf'       => $item['volume_mscf'],
                        'satuan_mscf'       => $item['satuan_mscf'],
                    ]
                );
    ...
    public function lihatSemuaData()
    {
        ...
        $query = BphPengangkutanGas::where('bulan', $bulan)
                    ->where('tahun', $tahun)
                    ->get();
        $perusahaan  = BphPengangkutanGas::groupBy('npwp_badan_usaha')->get();
